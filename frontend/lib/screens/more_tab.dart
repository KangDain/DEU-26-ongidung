        ...
        children: [
          ...
          _menuSection('기능', [
            _menuItem(
                ...
                Icons.notifications,
                '알림 관리',
                '${AppState.instance.unreadNotifications}개의 새 알림',
                () => Navigator.push(
                    context,
                    MaterialPageRoute(
          ...
          _menuSection('계정', [
            ...
            _menuItem(context, Icons.watch, 'IoT 기기 관리', '연결된 기기 확인 및 설정',
                () => _showDeviceManagement(context)),
            _menuItem(context, Icons.security, '보안 설정', 'PIN 번호, 생체인식 설정',
      ...
      builder: (_) => Column(
        ...
        children: [
          ...
          ...AppState.instance.devices.map((d) => ListTile(
                ...
                title: Text(d.name),
                subtitle:
                    Text(d.isConnected ? '연결됨 · ${d.batteryLevel}%' : '연결 끊김'),
                trailing: d.isConnected
                    ? const Icon(Icons.check_circle, color: Colors.green)
                    : ElevatedButton(
                        onPressed: () {},
                        child:
                            const Text('재연결', style: TextStyle(fontSize: 12))),
              )),
